...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "PingPayload.message":
		if e.complexity.PingPayload.Message == nil {
			break
		}

		return e.complexity.PingPayload.Message(childComplexity), true
...
var sources = []*ast.Source{
	{Name: "auth/api/user.graphql", Input: `scalar Time
...
`, BuiltIn: false},
	{Name: "graph/api/ping.graphql", Input: `type PingPayload {
  message: String!
}
...
func (ec *executionContext) _User_password(ctx context.Context, field graphql.CollectedField, obj *auth.User) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _User_deletedAt(ctx context.Context, field graphql.CollectedField, obj *auth.User) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
var pingPayloadImplementors = []string{"PingPayload"}

func (ec *executionContext) _PingPayload(ctx context.Context, sel ast.SelectionSet, obj *model.PingPayload) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, pingPayloadImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("PingPayload")
		case "message":
			out.Values[i] = ec._PingPayload_message(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
